...
urlpatterns = [
    ...
    path('communities', login_required(views.communities), name='communities'),
    ...
    path('leave_community', login_required(views.leave_community), name='leave_community'),
    ...
    path('display_join_invitations', login_required(views.display_join_invitations), name='display_join_invitations'),
]